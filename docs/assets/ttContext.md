...
TaskTonic/
    ...
    examples/
        ...
        networking_tcp_shelly_dimmer_control.py
        pyside_hello_world.py
    testing/
        test_core.py
        conftest.py
        test_distiller.py
    ...
    docs/
        ...
        TheToolbox/
            ...
            110 - TaskTonic - PySide UI the TaskTonic way.md
```
...
## `File: examples\networking_tcp_shelly_dimmer_control.py`
```python
...
## `File: examples\pyside_hello_world.py`
```python
...
[**Check out all examples in our GitHub repository ↗**](https://github.tasktonic.dev)## `File: docs\tasting-the-tonic.md`
# 🧪 Tasting The Tonic
